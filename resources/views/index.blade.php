                    ...
                    <div class="item product-item">
                        <div class="item__content">
                            <div class="item__image-wapper">
                                ...
                                <div class="item__icons-block icons-block">
                                    <span title="Нравится" class="icons-block__item button"><i class="far fa-heart"></i></span>
                                    <span title="В сравнение" class="icons-block__item button"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13"><path d="M595,137a1,1,0,0,1,1,1v8a1,1,0,1,1-2,0v-8A1,1,0,0,1,595,137Zm-4,3a1,1,0,0,1,1,1v5a1,1,0,1,1-2,0v-5A1,1,0,0,1,591,140Zm8-6a1,1,0,0,1,1,1v11a1,1,0,1,1-2,0V135A1,1,0,0,1,599,134Zm4,6h0a1,1,0,0,1,1,1v5a1,1,0,0,1-1,1h0a1,1,0,0,1-1-1v-5A1,1,0,0,1,603,140Z" transform="translate(-590 -134)"></path></svg></span>
                                    <span title="Быстрый просмотр" class="icons-block__item button"><i class="far fa-eye"></i></span>
                                </div>
                                <a href="#" class="item__thumb">
                                    <div class="item__image-selector image-selector">
